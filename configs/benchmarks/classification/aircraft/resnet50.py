...
model = dict(head=dict(num_classes=n_classes, type='ClsHeadWeightedNonLinear', mlp=False, weight=class_imbalances, dropout_rate=0.0, with_avg_pool=True, in_channels=2048), backbone=dict(frozen_stages=4))
