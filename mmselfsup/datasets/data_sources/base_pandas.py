...
class BaseDataSource(object, metaclass=ABCMeta):
    ...
    def __len__(self):
        ...
        # print(self.data_infos.shape[1])
        if type(self.data_infos) == list:
            return len(self.data_infos)
        else:
            return self.data_infos.shape[1]
    ...
    def get_gt_labels(self):
        ...
        print(self.data_infos)
        gt_labels = np.asarray(self.data_infos.loc['gt_label'], dtype=np.int64)
        return gt_labels
