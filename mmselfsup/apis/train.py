...
from mmselfsup.core import DistOptimizerHook
from mmselfsup.core import (GradAccumFp16OptimizerHook,)
...
def train_model(model,
    ...
    if "sampler" in cfg.data.train:
        data_loaders = [
            build_dataloader(
                ...
                sampler=cfg.data.train["sampler"]) for ds in dataset
                # use_cutmix=cfg.data.train.use_cutmix) for ds in dataset
            ]
    else:
        data_loaders = [
            build_dataloader(
    ...
    if cfg.get('evaluation', None):
        ...
        val_dataloader = build_dataloader(
            ...
            use_cutmix=cfg.data.val.use_cutmix)
